...
class PotenciaD(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PotenciaD", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PotenciaD")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PotenciaD")
...
def main(top_block_cls=PotenciaD, options=None):
