...
# Title: MultiplexaPAM
# Author: Daniel_Fernandez_Andres_Suarez
# Copyright: Daniel_Fernandez_Andres_Suarez
...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fs = fs = 2000
        self.fm = fm = 100
        self.Demodulador = Demodulador = 0
        self.D3 = D3 = 0
        self.D2 = D2 = 0
        self.D1 = D1 = 0
        self.D = D = 10
        ...
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "frecuencia_pulso", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._D3_win = RangeWidget(self._D3_range, self.set_D3, "Retardo_3", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D3_win)
        self._D2_range = Range(0, 100, 1, 0, 200)
        self._D2_win = RangeWidget(self._D2_range, self.set_D2, "Retardo_2", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D2_win)
        self._D1_range = Range(0, 100, 1, 0, 200)
        self._D1_win = RangeWidget(self._D1_range, self.set_D1, "retardo_1", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D1_win)
        self._D_range = Range(0, 50, 1, 10, 200)
        self._D_win = RangeWidget(self._D_range, self.set_D, "ancho_pulso", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._Demodulador_range = Range(0, 100, 1, 0, 200)
        self._Demodulador_win = RangeWidget(self._Demodulador_range, self.set_Demodulador, "demodulador", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Demodulador_win)
        ...
        self.connect((self.analog_sig_source_x_0_2, 0), (self.ModuladorPAM_0_2, 0))
    ...
    def get_Demodulador(self):
        return self.Demodulador

    def set_Demodulador(self, Demodulador):
        self.Demodulador = Demodulador
