...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "frecuencia_pulsos", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fs_win)
        self._fm_range = Range(0, 10000, 10, 100, 200)
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "frecuencia_del_mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
